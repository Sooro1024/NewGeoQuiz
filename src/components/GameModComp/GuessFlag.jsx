import { Button, Card, CardContent, CardHeader, CardMedia, Grow, LinearProgress, Slide, Typography } from "@material-ui/core";
...
const GuessFlag = ({ gameArray, dataForGame, onTime, gameMod, gameDiff }) => {
							...
							<Card style={{ minWidth: "550px" }}>
								...
								<CardContent style={{ paddingTop: "0" }}>
									<CardMedia
										...
										image={`${gameArray[state.length].flag}`}
									/>
								</CardContent>
							</Card>
							{onTime && (
